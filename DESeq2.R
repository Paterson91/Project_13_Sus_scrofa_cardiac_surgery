...
res1_lrt = results(ddskeep_lrt,contrast=c("timepoint","baseline","termination"), alpha = 0.05)
...
volcano_lrt = EnhancedVolcano(res1_lrt,
                ...
                selectLab = rownames(res1)[res1$padj <= 0.000000001], #label 20 most signifcant ASVs
                drawConnectors = TRUE, 
